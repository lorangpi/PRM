...
class ICM(nn.Module):
    def __init__(self, env, feature_dim, learning_rate=1e-3, eta=0.01):
    ...
    def train(self, replay_data, num_epochs=1):
        ...
        for epoch in range(num_epochs):
            ...
            # Step all schedulers
            # self.feature_extractor.scheduler.step()
            # self.forward_model.scheduler.step()
            # self.inverse_model.scheduler.step()
            # self.error_model.scheduler.step()
